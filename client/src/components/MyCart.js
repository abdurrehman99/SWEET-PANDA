        ...
        <div className="container mb-5 pb-5">
          <div className="row">
            <div className="col-xs-6 col-sm-9">
              <h2 className="m-5">
                You are not logged in <i className="fas fa-exclamation"></i>
              </h2>
            </div>
            <div className="col-xs-4 col-sm-3">
              <Link to="/login" className="mt-5 btn btn-secondary">
                <i className="fas fa-sign-in-alt"></i> Login
              </Link>
              <Link to="/itemlist" className="mt-5 btn btn-primary float-right">
        ...
        <div className="container mb-5 pb-5">
          <div className="row">
            <div className="col-xs-6 col-sm-8">
              <h2 className="m-5">
                <i className="text-danger fas fa-shopping-cart"></i> Your Cart
                is Empty !
              </h2>
            </div>
            <div className="col-xs-4 col-sm-4">
              <Link to="/itemlist" className="m-5 btn btn-primary float-right">
                <i className="fas fa-chevron-left"></i> Go Back
              </Link>
            </div>
          </div>
      ...
      return (
        <div className="container">
          <div className="row">
            ...
            <div className="col-xs-4 col-sm-4">
              <Link to="/itemlist" className="my-4 btn btn-primary float-right">
                <i className="fas fa-chevron-left"></i> Go Back
              </Link>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-xs-12 col-sm-12 col-md-6">
              <h4>
                Cash On Delivery <i className="fas fa-money-bill"></i>
              </h4>
              <input
              ...
              >
                <i className="fas fa-check-double"></i> Check Out{" "}
              </button>
            </div>
            <div className="col-xs-12 col-sm-12 col-md-6">
              <h4 className="mb-3">
                Stripe Checkout <i className="fab fa-cc-stripe"></i>
              </h4>
              <StripeCheckout
